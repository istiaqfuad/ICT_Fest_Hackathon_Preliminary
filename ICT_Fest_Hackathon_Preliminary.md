...
understand why they are broken, and fix them.
There are bugs hidden across the project,
...
contract described in this document (Sections 3 and 4).
Your fixes must preserve this
...
Members may read and cancel only their own bookings (another
...
token type:
"bearer"}; bad credentials →401 INVALID CREDENTIALS
...
• Availability: {room id, date, busy:
[{start time, end time}, ...]}
